...
def generate_tx_hist(amount, address, timestamp, bhash, thash, message, contract_code='', contract_output='', contract_priv_key=''):
    data = {}
    data["amount"] = amount
    ...
    data["contract_priv_key"] = contract_priv_key
